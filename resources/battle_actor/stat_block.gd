...
func add(stat_block: StatBlock) -> StatBlock:
	...
	new_stat_block.self_damage_offset = self.self_damage_offset + stat_block.self_damage_offset
	new_stat_block.self_posture_damage_offset = self.self_posture_damage_offset + stat_block.self_posture_damage_offset
